...
comment on column t_group_message.message_id is '群组全局唯一消息 ID';

comment on column t_group_message.sender is '发送人 ID';
...
create unique index t_group_message_gid_message_id_uindex
	on t_group_message (gid, message_id);
